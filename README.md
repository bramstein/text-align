...
The following examples selects all the cells in an example table, then uses the [jQuery Column Selector plugin](../column/) to select the first column, and finally aligns the cells in that column on the comma character.
